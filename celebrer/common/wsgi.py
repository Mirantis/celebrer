...
from celebrer.api.v1 import schemas
from celebrer.common import exceptions
from celebrer.common.i18n import _, _LE, _LW
from celebrer.common import xmlutils
...
class Service(service.Service):
    ...
    def reset(self):
        ...
        logging.setup(cfg.CONF, 'celebrer')
...
class Request(webob.Request):
    ...
    default_request_content_types = ('application/json',
                                     'application/xml',
                                     'application/celebrer-json-patch',
                                     'multipart/form-data')
...
class Resource(object):
    ...
    def _format_request_headers(self, headers):
        ...
        To keep log more clear, only show the X-* header include celebrer own
...
class RequestDeserializer(object):
    ...
    def __init__(self, body_deserializers=None, headers_deserializer=None,
        ...
        self.body_deserializers = {
            ...
            'application/celebrer-json-patch': JSONPatchDeserializer(),
